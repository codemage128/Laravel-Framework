        ...
        <div class="box animation flipInX">
            ...
            <h3 class="text-primary">Log In</h3>
                ...
                <div class="text-center">
                    <p>--OR--</p>
                    <p>Login with</p>
                    <a href="{{ url('/facebook') }}" class="social"><i class=" fab fa-facebook-f"></i> Facebook</a>

                    <a href="{{ url('/google') }}" class="social text-danger"><i class=" fab fa-google-plus-g"></i> Google</a>

                    {{--<a href="{{ url('/twitter') }}" class="social"><i class=" fa fa-twitter"></i> Twitter</a>--}}

                    <a href="{{ url('/linkedin') }}" class="social"><i class=" fab fa-linkedin-in"></i> LinkedIn</a>
                </div>
