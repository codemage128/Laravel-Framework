...
@section('content')
                    ...
                    <div class='col-xs-12'>
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a href="#features" data-toggle="tab" class="nav-link">FA features</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="fa-icons">
                                    <div class="input-group col-lg-4 center">
                                        <span class="input-group-addon" id="basic-addon1"><i
                                                    class=". ion ion-ios-search"></i></span>
                                    ...
                                    <ul class="pl-0 list-inline">
                                        ...
                                        <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x fab fa-accusoft"
                                        ...
                                        <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x fab fa-acquisitions-incorporated"
                                                                      data-filter="fa-acquisitions-incorporated"></i>
                                            </div>
                                        </li>
                                        <li class="list-inline-item  clr " data-toggle="tooltip"
                                        ...
                                        <li class="list-inline-item  clr" data-toggle="tooltip"
                                            data-original-title="fa-american-sign-language-interpreting">
                                            <div class="iconview "><i
                                                        class=". fa-2x fas fa-american-sign-language-interpreting"
                                                ></i></div>
                                        </li>
                                        <li class="list-inline-item  clr" data-toggle="tooltip"
                                        ...
                                        <li class="list-inline-item  clr" data-toggle="tooltip"
                                            data-original-title="fa-creative-commons-sampling-plus">
                                            <div class="iconview "><i
                                                        class=". fa-2x fab fa-creative-commons-sampling-plus"
                                                ></i></div>
                                        </li>
                                        <li class="list-inline-item  clr" data-toggle="tooltip"
                                ...
                                <div class="tab-pane" id="glyphicons">
                                    <div class="input-group col-lg-4 center">
                                        <span class="input-group-addon" id="basic-addon1"><i
                                                    class=". ion ion-ios-search"></i></span>
                                        <input type="text" class="form-control" placeholder="search icon"
                                               aria-describedby="basic-addon1" id="search4">
                                    </div>
                                    ...
                                    <div class="tab-pane active" id="fa-icons">
                                        <div class="input-group col-lg-4 center">
                                            <span class="input-group-addon" id="basic-addon1"><i
                                                        class=". ion ion-ios-search"></i></span>
                                            <input type="text" class="form-control" placeholder="search icon"
                                                   aria-describedby="basic-addon1" id="search1">
                                        </div>
                                        <ul class="pl-0 list-inline">
                                            <ul class="pl-0 list-inline">
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-add-circle-outline">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-add-circle-outline"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-alert"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-american-football">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-american-football"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-arrow-down"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-arrow-dropdown-circle">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-arrow-dropdown-circle"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-arrow-dropdown"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-arrow-dropleft-circle">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-arrow-dropleft-circle"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-arrow-dropleft"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-arrow-dropright-circle">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-arrow-dropright-circle"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-arrow-dropright"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-arrow-dropup-circle">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-arrow-dropup-circle"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-arrow-forward"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-arrow-round-back">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-arrow-round-back"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-arrow-round-down">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-arrow-round-down"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-arrow-round-forward">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-arrow-round-forward"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-basketball"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-battery-charging">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-battery-charging"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-chatbubbles"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-checkbox-outline">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-checkbox-outline"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-checkbox"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-checkmark-circle-outline">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-checkmark-circle-outline"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-checkmark-circle">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-checkmark-circle"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-clock"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-close-circle-outline">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-close-circle-outline"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-git-network"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-git-pull-request">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-git-pull-request"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-help-buoy"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-help-circle-outline">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-help-circle-outline"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-infinite"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-information-circle-outline">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-information-circle-outline"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-information-circle">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-information-circle"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-navigate"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-notifications-off">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-notifications-off"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-notifications-outline">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-notifications-outline"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-quote"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-radio-button-off">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-radio-button-off"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-refresh"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-remove-circle-outline">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-remove-circle-outline"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                            ...
                                            <div class="iconview "><i class=". fa-2x ion ion-md-sync"
                                                ...
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                                    data-original-title="ion-md-tablet-landscape">
                                                    <div class="iconview "><i
                                                                class=". fa-2x ion ion-md-tablet-landscape"
                                                        ></i>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item  clr " data-toggle="tooltip"
                                ...
                                <div class="tab-pane" id="lineicons">
                                    <div class="input-group col-lg-4  center">
                                        <span class="input-group-addon" id="basic-addon1"><i
                                                    class=". ion ion-ios-search"></i></span>
                                        <input type="text" class="form-control" placeholder="search icon"
                                               aria-describedby="basic-addon1" id="search2">
                                    </div>
                                    <ul class="pl-0 list-inline">
                                        <li class="list-inline-item  clr " data-toggle="tooltip"
                                        ...
                                        <li class="list-inline-item  clr " data-toggle="tooltip"
                                            data-original-title="icon-size-actual">

                                            <div class="iconview ">
                                                <i class=". fa-2x icon-size-actual"></i></div>
                                        </li>
                                        <li class="list-inline-item  clr " data-toggle="tooltip"
                                            data-original-title="icon-size-fullscreen fa-2x">

                                            <div class="iconview ">
                                                <i class=". fa-2x icon-size-fullscreen"></i></div>
                                        </li>
                                        <li class="list-inline-item  clr " data-toggle="tooltip"
                                ...
                                <div class="tab-pane " id="features">
                                    ...
                                    <!--main content-->
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8 col-lg-8 col-12 col-xs-offset-2">
                                            <div class="panel panelstyle">
                                                <div class="panel-heading panel-outline-info">
                                                    <h3 class="panel-title text-info">
                                                        <i class=" livicon" data-name="rocket" data-size="16"
                                                           data-loop="true" data-c="#48899c" data-hc="#48899c"></i>
                                                        Sizing icons
                                                    </h3>
                                                    <span class="iconright">
                                    <i class=" fa fa-chevron-up clickable1 text-info"></i>
                                </span>
                                                </div>
                                                <div class="panel-body space">
                                                    <i class=" fas fa-archway fa-xs "></i>
                                                    ...
                                                    <button class="btn btn-custom-info btn-outline-info text-info"
                                                ...
                                                <div class="collapse" id="collapseExample">
                                                    <div class="panel panel-body">
                                                        <?php
                                                        $str = '<i class=" fa-2x fas fa-igloo fa-xs"></i>
                                                    <i class=" fas fa-archway fa-sm"></i>
                                                    <i class=" fas fa-archway fa-lg"></i>
                                                    <i class=" fas fa-archway fa-2x"></i>
                                                    <i class=" fas fa-archway fa-3x"></i>
                                        ...
                                        <div class="col-md-8 col-sm-8 col-lg-8 col-12 col-xs-offset-2">
                                            <div>
                                                <div class="panel panelstyle">
                                                    <div class="panel-heading panel-outline-info">
                                                        <h3 class="panel-title text-info">
                                                            <i class=" livicon" data-name="help" data-size="16"
                                                               data-loop="true" data-c="#48899C" data-hc="#48899C"></i>
                                                            Rotating icons
                                                        </h3>
                                                        <span class="iconright ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8 col-lg-8 col-12 col-xs-offset-2">
                                            <div class="panel panelstyle">
                                                <div class="panel-heading panel-outline-info">
                                                    <h3 class="panel-title text-info">
                                                        <i class=" livicon" data-name="check-circle" data-size="16"
                                                           data-loop="true" data-c="#48899c" data-hc="#48899c"></i>
                                                        Animating icons
                                                    </h3>
                                                    <span class="iconright">
                                    <i class=" fa fa-chevron-up clickable1 text-info"></i>
                                                ...
                                                <div class="panel-body space">
                                                    ...
                                                    <button class="btn btn-custom-info text-info" type="button"
  ...
  <i class=" fas fa-star-christmas fa-spin"></i>
                                    ...
                                    <div class="row">
                                        <div class=" col-lg-8 col-12 col-xs-offset-2">
                                            <div class="panel panelstyle">
                                                <div class="panel-heading panel-outline-info">
                                                    <h3 class="panel-title text-info">
                                    ...
                                    <i class=" fa fa-chevron-up clickable1 text-info"></i>
                                                ...
                                                <div class="panel-body space">
                                                    <div class="fa-3x">
                                                        <i class=" fas fa-adjust fa-adjust text-primary"></i>
                                                        <i class=" fas fa-adjust fa-adjust text-danger "></i>
                                                        <i class=" fas fa-adjust fa-adjust text-info "></i>
                                                        <i class=" fas fa-adjust fa-adjust text-success "></i>
                                                        <i class=" fas fa-adjust fa-adjust text-secondary"></i>
                                                        <i class=" fas fa-adjust fa-adjust text-warning "></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
