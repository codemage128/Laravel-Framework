...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('assets/vendors/fancybox/helpers/css/jquery.fancybox-buttons.css') }}"/>
    <!-- Add Thumbnail helper (this is optional) -->
    <link rel="stylesheet" type="text/css"
          href="{{ asset('assets/vendors/fancybox/helpers/css/jquery.fancybox-thumbs.css') }}"/>
    <!--page level css end-->
@stop
...
@section('footer_scripts')
    ...
    <script type="text/javascript"
            src="{{ asset('assets/vendors/fancybox/helpers/js/jquery.fancybox-buttons.js') }}"></script>
    <script type="text/javascript"
            src="{{ asset('assets/vendors/fancybox/helpers/js/jquery.fancybox-thumbs.js') }}"></script>
    <!-- Add Media helper (this is optional) -->
    <script type="text/javascript"
            src="{{ asset('assets/vendors/fancybox/helpers/js/jquery.fancybox-media.js') }}"></script>
