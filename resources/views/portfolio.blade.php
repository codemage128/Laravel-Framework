...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendors/fancybox/helpers/css/jquery.fancybox-buttons.css') }}">
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{ asset('assets/vendors/fancybox/helpers/js/jquery.fancybox-buttons.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/vendors/fancybox/helpers/js/jquery.fancybox-media.js') }}"></script>
